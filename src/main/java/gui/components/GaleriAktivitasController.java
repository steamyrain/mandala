...
@ViewController(value="/gui/components/GaleriAktivitas.fxml")

public class GaleriAktivitasController {
    @FXML
    ...
    public void init(){
        ...
        for (int i = 0; i < 20; i++) {
            ...
            button.setRipplerFill(javafx.scene.paint.Color.valueOf(headerColor));
            button.setScaleX(0);
            button.setScaleY(0);
