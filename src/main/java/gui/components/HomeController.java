...
public class HomeController {
    ...
    @FXML
    private void reset(){
        noTelpTextField.setText(buffAccount.getNoTelp());
        emailTextField.setText(buffAccount.getEmail());
        negara.getSelectionModel().select(currAcc.getCountryID().intValue());
        provinsi.getSelectionModel().select(currAcc.getStateID().intValue());
        kota.getSelectionModel().select(currAcc.getCityID().intValue());
    }
